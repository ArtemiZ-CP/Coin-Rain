...
public class GameZone : MonoBehaviour
{
    ...
    public void UpdateZone()
    {
        ...
        float upBorder = -1 * (PlayerMapUpgradesData.MapHeight - 1) * pinConstants.OffsetBetweenLines;
        float height = 1;
        float width = (PlayerMapUpgradesData.MapWidth + 1) * pinConstants.OffsetBetweenPinsInLine * 2;
