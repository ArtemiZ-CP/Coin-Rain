...
public class Borders : MonoBehaviour
{
    ...
    public void UpdateBorders()
    {
        ...
        float positionX = (PlayerData.WidthUpgrade + 1) * pinConstants.OffsetBetweenPinsInLine + _boardWidth / 2;
        ...
        float minHeight = -1 * (PlayerData.HeightUpgrade - 1) * pinConstants.OffsetBetweenLines - 0.5f;
