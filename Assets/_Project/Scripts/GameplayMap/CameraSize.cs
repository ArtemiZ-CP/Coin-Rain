...
public class CameraSize : MonoBehaviour
{
    ...
    public void UpdateSize()
    {
        ...
        float downBorder = -1 * PlayerData.HeightUpgrade * pinConstants.OffsetBetweenLines;
        ...
        float width = (PlayerData.WidthUpgrade + 1) * 2 * pinConstants.OffsetBetweenPinsInLine;
